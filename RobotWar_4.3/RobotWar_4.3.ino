...
void loop() {
  ...
  if (swD >= 2000 - err && swD <= 2000 + err) {
    ...
    if ((stY >= 1500 - err && stY <= 1500 + err) && (stX >= 1500 + err || stX <= 1500 - err)) {//поворот танком
      if (stX < 1500) {
    ...
    else if ((stX >= 1500 + err || stX <= 1500 - err) && (stY >= 1500 + err || stY <= 1500 - err)) {//повороты циркулем
      if (stX < 1500) {
        if (map(stY, 1000, 1500, 0, vrB) - abs(stX - 1500) < 0) {
          speed_rf = map(stY, 1000, 1500, vrA, 0);
          speed_lf = 0;
          speed_rb = 0;
          speed_lb = 0;
        }
          ...
          speed_rf = map(stY, 1000, 1500, vrA, 0);
          speed_lf = map(stY, 1000, 1500, vrA, 0) - abs(stX - 1500);
          speed_rb = 0;
          speed_lb = 0;
        }
      }
      if (stX > 1500) {
        if (map(stY, 1500, 2000, 0, vrA) - abs(stX - 1500) < 0) {
          speed_rf = 0;
          ...
          speed_rf = map(stY, 1500, 2000, 0, vrA) - abs(stX - 1500);
          speed_lf = map(stY, 1500, 2000, 0, vrA);
          speed_rb = 0;
          speed_lb = 0;
        }
